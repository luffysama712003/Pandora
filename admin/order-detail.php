                            ...
                            <div style="padding-left: 20px">
                                <?php foreach($orders as $order){ ?>
                                    ...
                                    <?php 
                                        ...
                                        if ($order['status'] == 2){
                                            echo "<a href='./code.php?order=3&id=$id_order'><span class='badge badge-sm bg-gradient-info'>Đang giao</span></a>";
                                        }else if ($order["status"] == 3){
                                            echo "<a href='./code.php?order=4&id=$id_order'><span class='badge badge-sm bg-gradient-success'>Đã giao</span></a>";
                                        }else if ($order["status"] == 4){
                                            echo "<span class='badge badge-sm bg-gradient-primary'>Đã đặt</span>";
                                        }
                                    ?>
                                ...
                                <?php foreach($orders as $order){ ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <p class="text-xs text-secondary mb-0">Chi tiết: <?= $order['quantity'] ?></p>
                                        </td>
                                        <td>
